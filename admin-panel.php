...
include('func.php');  
include('newfunc.php');
$con=mysqli_connect("localhost:3305","root","","myhmsdb");
...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> CANARA HOSPITALS</h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> CANARA HOSPITALS </a>
